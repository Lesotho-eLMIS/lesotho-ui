...
(function() {
    ...
    function config($stateProvider, CCE_RIGHTS) {
        ...
        $stateProvider.state('openlmis.equipment.inventory.add', {
            url: '/add',
            onEnter: onEnter,
            onExit: onExit,
        ...
        function onEnter(openlmisModalService, catalogItems, types) {
            dialog = openlmisModalService.createDialog({
                backdrop: 'static',
                templateUrl: 'equipment-add-inventory-item/add-equipment-item.html',
                controller: 'AddEquipmentItemController',
                controllerAs: 'vm',
                resolve: {
