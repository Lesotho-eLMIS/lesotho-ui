...
(function() {
    ...
    /**
     * @ngdoc controller
     * @name complaint-modal.controller:complaintModalController
     *
     * @description
     * Manages Add Discrepancy Modal.
     */
    angular
        .module('complaint-modal')
        .controller('complaintModalController', controller);
    ...
    function controller( pointOfDeliveryService, rejectionReasons, $filter, shipmentType, notificationService, modalDeferred, discrepancies) {
        ...
        /**
         * @ngdoc method
         * @methodOf complaint-modal.controller:complaintModalController
         * @name $onInit
         *
         * @description
