    ...
    function supersetReports(SUPERSET_URL) {
        ...
        if (SUPERSET_URL.substr(0, 2) !== '${') {
            reports = {
                ...
                ORDERFILL: createReport('orderFill',
                        SUPERSET_URL + '/superset/dashboard/order_fill/',
                        'STOCK_STATUS_REPORT_VIEW'),
                EXPIREDANDUNSERVICEABLE: createReport('expiredAndUnserviceable',
                            SUPERSET_URL + '/superset/dashboard/expired_unserviceable/',
                            'STOCK_STATUS_REPORT_VIEW'),
                REPORTINGTIMELINESS: createReport('reportingtimeliness',
                                SUPERSET_URL + '/superset/dashboard/reporting_timeliness/',
                                'STOCK_STATUS_REPORT_VIEW'),
                PATIENTS: createReport('patients',
                    SUPERSET_URL + '/superset/dashboard/patients/',
                    'STOCK_STATUS_REPORT_VIEW'), 
                STOCKOUTS: createReport('stockouts',
                    SUPERSET_URL + '/superset/dashboard/stock_out/',
