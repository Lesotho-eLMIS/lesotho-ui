...
(function() {
    ...
    /**
     * @ngdoc service
     * @name dispensing-prescription-details-modal.dispensingPrescriptionDetailsModalService
     *
     * @description
     * This service will pop up a modal window for user to add discrepancies.
     */
    angular
        .module('dispensing-prescription-details-modal')
        .service('dispensingPrescriptionDetailsModalService', service);
    ...
    function service(openlmisModalService) {
      //  this.show = show;
        ...
        // // /**
        // //  * @ngdoc method
        // //  * @methodOf dispensing-prescription-details-modal.dispensingPrescriptionDetailsModalService
        // //  * @name show
        // //  *
        // //  * @description
        ...
        // //             controllerAs: 'vm',
        // //             templateUrl: 'dispensing-prescription-details-modal/add-discrepancy-modal.html',
        // //             show: true ,
        // //             resolve: {
