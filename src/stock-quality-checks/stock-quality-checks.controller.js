...
(function() {
    ...
    /**
     * @ngdoc controller
     * @name stock-quality-checks.controller:StockQualityChecksController
     *
     * @description
     * Controller for requisition view page.
     */
    angular
        .module('stock-quality-checks')
        .controller('StockQualityChecksController', StockQualityChecksController);

        StockQualityChecksController.$inject = [
        '$state', '$filter', '$stateParams', 'facilities', 'offlineService', 'localStorageFactory', 'confirmService',
        'requisitions', 'REQUISITION_STATUS'
    ];

    function StockQualityChecksController($state, $filter, $stateParams, facilities, offlineService, localStorageFactory,
        ...
        /**
         * @ngdoc property
         * @propertyOf stock-quality-checks.controller:StockQualityChecksController
         * @name facilities
         * @type {Array}
         *
         * @description
        ...
        /**
         * @ngdoc method
         * @methodOf stock-quality-checks.controller:StockQualityChecksController
         * @name $onInit
         *
         * @description
