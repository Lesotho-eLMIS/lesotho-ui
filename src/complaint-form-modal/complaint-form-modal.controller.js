...
(function() {
    ...
    controller.$inject = [ 'modalDeferred', '$scope', 'rejectionReasons', 'itemTimestamp', 'stockAdjustmentCreationService', 'notificationService', 
        'orderableGroups', 'program', 'facility', 'programService', 'orderableGroupService', 'hasPermissionToAddNewLot'];//

    function controller( modalDeferred, $scope, rejectionReasons, itemTimestamp, stockAdjustmentCreationService, 
                        notificationService, orderableGroups, program, faciity, programService, orderableGroupService, hasPermissionToAddNewLot) {//
        var vm = this;
