...
(function() {
    ...
    controller.$inject = [ 'modalDeferred', '$scope', 'messageService', 'complaintService','confirmService', 'complaintFormViewModalService'];

    function controller( modalDeferred, $scope, messageService, complaintService, confirmService, complaintFormViewModalService) {//
        var vm = this;
