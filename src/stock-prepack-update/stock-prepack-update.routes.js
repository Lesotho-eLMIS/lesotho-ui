...
(function() {
    ...
    function routes($stateProvider, SEARCH_OPTIONS, STOCKMANAGEMENT_RIGHTS, ADJUSTMENT_TYPE) {
        $stateProvider.state('openlmis.stockmanagement.prepack.update', {
            url: '/:facilityId?programId?prepackId/update',
            views: {
                '@openlmis': {
                    controller: 'prepackUpdateController',
                    templateUrl: 'stock-prepack-update/prepack-update.html',
                    controllerAs: 'vm'
                }
            },
            ...
            resolve: {
                ...
                prepack: function($stateParams, prepackingService) { 
                    return prepackingService.getPrepack($stateParams.prepackId);
                },
