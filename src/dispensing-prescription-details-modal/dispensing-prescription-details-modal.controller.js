...
(function() {
    ...
    /**
     * @ngdoc controller
     * @name dispensing-prescription-details-modal.controller:dispensingPrescriptionDetailsModalController
     *
     * @description
    ...
    angular
        ...
        .controller('dispensingPrescriptionDetailsModalController', controller);
    ...
    function controller( pointOfDeliveryService, rejectionReasons, $filter, shipmentType, notificationService, modalDeferred) {
        ...
        /**
         * @ngdoc method
         * @methodOf dispensing-prescription-details-modal.controller:dispensingPrescriptionDetailsModalController
         * @name $onInit
         *
         * @description
